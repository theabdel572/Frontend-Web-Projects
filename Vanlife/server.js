...
createServer({
    ...
    seeds(server) {
        ...
        server.create("van", { id: "4", name: "Dream-finder", price: 65, description: "Dream-finder is the perfect van to travel in and experience. With a ceiling height of 2.1m, you can stand up in this van and there is great head room. The floor is a beautiful glass-reinforced plastic (GRP) which is easy to clean and very hard wearing. A large rear window and large side windows make it really light inside and keep it well ventilated.", imageUrl: "https://assets.scrimba.com/advanced-react/react-router/dreamfinder.png", type: "simple", hostId: "789" })
    ...
    routes() {
        ...
        this.post("/login", (schema, request) => {
            ...
            // ⚠️ This is an extremely naive version of authentication. I'd never
            // do this in the real world, and I'd never save raw text passwords
            // in my database. 😅
